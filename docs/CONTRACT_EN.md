...
Before quoting, the Contractor may independently inspect and run the Client’s sanitized public hands-on project: the public repository is [vendure-project-briefing](https://github.com/vendure-ai-factory/vendure-project-briefing), and the test images are under [`evaluation-demo/assets/nail-patterns/`](https://github.com/vendure-ai-factory/vendure-project-briefing/tree/codex/github-refactor-20260904/evaluation-demo/assets/nail-patterns). The current public hands-on revision is branch `codex/github-refactor-20260904`, commit `95329a7`, containing 199 sanitized JPG/PNG files. The original subdirectory structure must be preserved; the images must not be mixed, flattened, or renamed. The Contractor may clone or fork the public repository into the Contractor’s own environment, read the project documentation, run the demo, modify the Contractor’s own copy, and submit a pull request or fork link. A pull request or fork is only a way to demonstrate the hands-on result; it does not require the Client to merge the code and does not grant access to the Client’s `main`, private repositories, minipc, or production environment.
