...
5. Read the [public contractor testing environment guide](testing-environment-guide-en.md) before using any staging entry point.
6. Read [../evaluation-demo/task.md](../evaluation-demo/task.md).
7. Inspect the public test image materials in [../evaluation-demo/assets/nail-patterns/](../evaluation-demo/assets/nail-patterns/).
8. Inspect the [sanitized migration input package](../evaluation-demo/migration-input/), especially `legacy/`, `acceptance-inputs/`, and `PUBLICATION_SANITIZATION_REPORT.md`.
9. Run `node ../evaluation-demo/scripts/run-demo.mjs` from this directory, or use the commands in the repository README.
10. Inspect the generated `evaluation-demo/results/<run_id>/` evidence.
11. Fork the repository if you want to modify the starter and prove your own approach.
12. Send the project owner your feasibility judgment, fixed quote, delivery period, scope, assumptions, risks, and fork or commit link.
