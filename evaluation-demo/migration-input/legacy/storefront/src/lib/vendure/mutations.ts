...
export const SetSessionCurrencyCodeMutation = graphql(`
    mutation SetSessionCurrencyCode($currencyCode: String!) {
        setSessionCurrencyCode(currencyCode: $currencyCode) {
            __typename
            ... on Order {
                id
                code
...
`);
export const SetOrderMergeCustomFieldsMutation = graphql(`
    mutation SetOrderMergeCustomFields($input: SetOrderMergeCustomFieldsInput!) {
        setOrderMergeCustomFields(input: $input) {
            __typename
            ... on Order {
                id
                code
...
export const SwitchCustomerCountryMutation = graphql(`
    mutation SwitchCustomerCountry($newCountryCode: String!) {
        switchCustomerCountry(newCountryCode: $newCountryCode) {
            __typename
            success
            message
            oldBonus
...
export const TransferBalanceMutation = graphql(`
...
export const RequestDesignerStatusMutation = graphql(`
    mutation RequestDesignerStatus($agbVersion: String!) {
        requestDesignerStatus(agbVersion: $agbVersion) {
            success
            message
        }
    }
`);
export const RequestPayoutMutation = graphql(`
...
export const VerifyAffiliateKycMutation = graphql(`
    mutation VerifyAffiliateKyc {
        verifyAffiliateKyc {
            id
            hash
            source
...
export const AlignOrderRateMutation = graphql(`
    mutation AlignOrderRate($orderId: ID!) {
        alignOrderRate(orderId: $orderId)
    }
`);
