...
async function FooterContent({ countryCode }: { countryCode?: string }) {
    'use cache'
    cacheLife('days');
    ...
    return (
        <footer className="border-t border-border mt-auto" suppressHydrationWarning>
...
export async function Footer({ countryCode }: { countryCode?: string }) {
    return <FooterContent countryCode={countryCode} />;
}
