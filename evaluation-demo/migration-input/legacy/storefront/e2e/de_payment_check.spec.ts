...
test('Germany Payment Check', async ({ page, context }) => {
    test.setTimeout(120000);
    await context.clearCookies();
    
    // 1. 登录
    await page.goto('/de/sign-in', { waitUntil: 'networkidle' });
    await page.locator('input[type="email"]').fill('test3@example.com');
    ...
    await page.goto('/de/checkout', { waitUntil: 'networkidle' });
